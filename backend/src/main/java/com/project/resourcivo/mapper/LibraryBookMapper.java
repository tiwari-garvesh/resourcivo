...
public final class LibraryBookMapper {
    ...
    public static LibraryBook toEntity(LibraryBookCreateDTO dto) {
        ...
        if (dto.getYearBought() != null)
            e.setYearBought(dto.getYearBought());
        ...
        if (dto.getReviews() != null)
            e.setReviews(dto.getReviews());
        if (dto.getAbout() != null)
            e.setAbout(dto.getAbout());
        if (dto.getIsIssued() != null)
            e.setIsIssued(dto.getIsIssued());
        return e;
    }
    ...
    public static void mergeUpdate(LibraryBookUpdateDTO dto, LibraryBook entity) {
        ...
        if (dto.getYearBought() != null)
            entity.setYearBought(dto.getYearBought());
        if (dto.getAuthor() != null)
        ...
        if (dto.getIsIssued() != null)
            entity.setIsIssued(dto.getIsIssued());
    }
    ...
    public static LibraryBookResponseDTO toResponse(LibraryBook e) {
        ...
        if (e.getLibrary() != null) {
            ...
            r.setLibraryName(e.getLibrary().getName());
        }
        return r;
    }
}
